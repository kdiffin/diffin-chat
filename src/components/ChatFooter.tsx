...
function ChatFooter(props: {
  ...
  return (
    <div
      className=" dark:bg-zinc-800   p-1  pb-3  z-10
      sticky bottom-0        bg-[#ececee]  flex items-center justify-center"
    >
      <div className=" p-2 my- dark:bg-[#212124]  sticky bottom bg-zinc-200 w-[96%] border-2 dark:border-none   rounded-lg dark:text-white ">
